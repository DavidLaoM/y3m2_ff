...
rng(1), randVals = -3 + 6 * rand(nMPSA,2);
% 
xMPSA = zeros(nMPSA,length(x));
for i = 1:nMPSA
    xMPSA(i,:) = x;
    xMPSA(i,parsGLT) = randVals(i,:);
    xMPSA(i,38) = xMPSA(i,35);
end
...
simRes1_1_repeat = simRes1(rangeTemp);
save('fig2_simRes_1.mat','simRes1_1_repeat')
% 
delete(pool)
...
simRes1_2_repeat = simRes1(rangeTemp);
save('fig2_simRes_2.mat','simRes1_2_repeat')
% 
delete(pool)
...
simRes1_3_repeat = simRes1(rangeTemp);
save('fig2_simRes_3.mat','simRes1_3_repeat')
% 
delete(pool)
...
simRes1_4_repeat = simRes1(rangeTemp);
save('fig2_simRes_4.mat','simRes1_4_repeat')
% 
delete(pool)
...
simRes1_5_repeat = simRes1(rangeTemp);
save('fig2_simRes_5.mat','simRes1_5_repeat')
% 
delete(pool)
...
simRes1_6_repeat = simRes1(rangeTemp);
save('fig2_simRes_6.mat','simRes1_6_repeat')
% 
delete(pool)
...
simRes1_7_repeat = simRes1(rangeTemp);
save('fig2_simRes_7.mat','simRes1_7_repeat')
% 
delete(pool)
...
simRes1_8_repeat = simRes1(rangeTemp);
save('fig2_simRes_8.mat','simRes1_8_repeat')
% 
delete(pool)
...
simRes1_9_repeat = simRes1(rangeTemp);
save('fig2_simRes_9.mat','simRes1_9_repeat')
% 
delete(pool)
...
simRes1_10_repeat = simRes1(rangeTemp);
save('fig2_simRes_10.mat','simRes1_10_repeat')
% 
delete(pool)
...
% % % % % % % load them
% % % % % % load('fig2_simRes_1.mat','simRes1_1_repeat')
% % % % % % load('fig2_simRes_2.mat','simRes1_2_repeat')
% % % % % % load('fig2_simRes_3.mat','simRes1_3_repeat')
% % % % % % load('fig2_simRes_4.mat','simRes1_4_repeat')
% % % % % % load('fig2_simRes_5.mat','simRes1_5_repeat')
% % % % % % % 
% % % % % % load('fig2_simRes_6.mat','simRes1_6_repeat')
% % % % % % load('fig2_simRes_7.mat','simRes1_7_repeat')
% % % % % % load('fig2_simRes_8.mat','simRes1_8_repeat')
% % % % % % load('fig2_simRes_9.mat','simRes1_9_repeat')
% % % % % % load('fig2_simRes_10.mat','simRes1_10_repeat')
% % % % % % 
...
% % % % % %     fh_10 = figure(10);
% % % % % % end
% % % % % % fh_10.Position = [1981 730 542 221];
% % % % % % 
% % % % % % % sp1
% % % % % % subplot(1,2,1)
...
% % % % % % ylabel('v_{HXT} at time = 20 s (mM s^{-1})')
% % % % % % xlabel('v_{HXT} at time = 400 s (mM s^{-1})')
% % % % % % % 
% % % % % % % % xlim([0 1.5])
% % % % % % % % ylim([0 0.4])
% % % % % % ylim([0 1.5])
...
% % % % % % s.MarkerEdgeColor = 'k';
% % % % % % s.MarkerFaceColor = 'r';
% % % % % % ylabel('v_{HXT} (mM s^{-1})')
% % % % % % xlabel('Time (s)')
% % % % % % box on
% % % % % % 
% % % % % % 
% % % % % % %% 
% % % % % % print(gcf,'-dpdf','E:\OneDrive - TU Eindhoven\Documents\ch5_Y3M2_FF\workingVersion\IntraCycles\RESULTS\figures_manuscript\F6AB');
% % % % % % 
% % % % % % 
% % % % % % % %% Saving outcome
...
% % % % % %     fh_11 = figure(11);
% % % % % % end
% % % % % % fh_11.Position = [1981 730 542 221];
% % % % % % 
% % % % % % % 
% % % % % % subplot(1,2,1)
% % % % % % % scatter data
...
% % % % % % s = scatter(vGLT_end,vGLT_20,20, xMPSA(:,35),'Filled');
% % % % % % % 
% % % % % % s.LineWidth = 0.6;
% % % % % % s.SizeData = 15;
% % % % % % % 
...
% % % % % % text(0.025, 1.3, 'Km.GLTic', 'FontSize', 14)
% % % % % % 
% % % % % % box on
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % % % % % subplot(1,2,2)
...
% % % % % % s = scatter(vGLT_end,vGLT_20,20, xMPSA(:,36),'Filled');
% % % % % % % 
% % % % % % s.LineWidth = 0.6;
% % % % % % s.SizeData = 15;
% % % % % % % 
...
% % % % % % text(0.025, 1.3, 'Vmax', 'FontSize', 14)
% % % % % % 
% % % % % % box on
% % % % % % 
% % % % % % 
% % % % % % %%
% % % % % % print(gcf,'-dpdf','E:\OneDrive - TU Eindhoven\Documents\ch5_Y3M2_FF\workingVersion\IntraCycles\RESULTS\figures_manuscript\FS5pre_redoing');
% % % % % % 
% % % % % % 