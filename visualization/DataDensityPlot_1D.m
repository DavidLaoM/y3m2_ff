function [ f , range90] = DataDensityPlot_1D( x, y, levels, fig_id, sp_id, robust_setup)
...
%        [map,range90] = dataDensity_1D(x, y, robust_setup.dpVal, robust_setup.dpVal_yaxis, robust_setup);
       [map,range90] = dataDensity_2D_histogram(x, y, robust_setup.dpVal, robust_setup.dpVal_yaxis, robust_setup);
%     end
...
%     colormap(flipud(autumn(levels)));
    ...
    set(gca, 'XTick', [1 robust_setup.dpVal]);
