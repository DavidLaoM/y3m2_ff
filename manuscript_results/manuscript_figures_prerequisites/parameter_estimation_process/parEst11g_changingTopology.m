...
%% Changing reaction topology
% x0 = x: reference
% x1 = x-like: lowering vacT
% x2 = x1-like: trehalose_ec degradation is off

x0 = x;
x1 = x; x1(155) = x1(155) + 1;
x2 = x; x2(155) = x2(155) + 5; %
x3 = x1; x3(164) = x3(164) - 10;
...
%% seconds test, silencing agt1 and nth1 to get tre_cyt higher

x1 = x; x1(155) = x1(155) + 1;
x1b = x1; x1b(152) = x1b(152) - 10;
x1c = x1; x1c(123) = x1c(123) - 10;
x1d = x1; x1d([123 152]) = x1d([123 152]) - 10;

xAll1 = [x1; x1b; x1c; x1d];
...
%% third test, more tre degradation outside
x1c;
x1c_b = x1c; x1c_b(164) = x1c_b(164) + 1;
x1c_c = x1c; x1c_c(164) = x1c_c(164) + 2;
x1c_d = x1c; x1c_d(164) = x1c_d(164) + 5;
x1c_e = x1c; x1c_e(164) = x1c_e(164) + 10;

xAll1_c = [x1c_b; x1c_c; x1c_d; x1c_e];
...
%% checking the effect of the TRE that gets taken from the broth
...
choosedataset
setup.experiment = 1;
[T_FF01_1,Y_FF01_1,V_FF01_1] = simulate_FF(x1c,canelas_SS,data,dataset,setup,NumberCycles,plotflag,IC);
plotMode = 2; % multiple simulations
% clear selResCell
selResCell{1}.T_FF01 = T_FF01_1;
selResCell{1}.Y_FF01 = Y_FF01_1;
...
temp_selResCell = selResCell;
clear selResCell
selResCell = temp_selResCell(1);

referencePlotSimulations
plotMode = 0;


%% simulate results, with no vOUT treEC
setup.TREec_brothOut_OFF = 1; 
    % 1-6
    % 7-14
% nParts = length(namesHits1);
