...
%     selResCell{1}.V_FF01 = V_FF01_1;
%     % save
%     saveName = sprintf('pE7_psa_n%d.mat',o);
...
simRes1 = cell(1,nS);
for i = 1:nS
    loadName = sprintf('pE7_psa_n%d.mat',i);
    load(loadName);
...
for i = 1:length(simRes1)
    ATHvac100 = interp1(selResCell{i}.T_FF01, selResCell{i}.V_FF01(:,46), 100, 'pchip');
%     if ATHvac100 > 0.0001
        fprintf('i = %f, ATHvac100 = %f.\n', i, ATHvac100);
%     end
end
...
%% save pars
x_pE7_start = xArray(1,:);
x_pE7_end = xArray(11,:);
% 
save('pset_pE7_xres.mat','x_pE7_start','x_pE7_end');
