...
% %%
simRes1_16a = simRes1;
save('tempRes_16a.mat','simRes1_16a')
%%
...
%
pE16a_w_simHXK_916 = [1E-3 1E-2 1E-1 1E0 3E0 1E1 1E2 1E3];
pE16a_w_refY3M1_916 = ones(1,nPoints);

% 
pE16a_error_simHXK_18 = zeros(1,nPoints);
pE16a_error_simHXK_916 = zeros(1,nPoints);
pE16a_error_pars_18 = zeros(1,nPoints);
pE16a_error_pars_916 = zeros(1,nPoints);
% 
...
for i = 1:nPoints
    ...
    pE16a_error_pars_18(i) = sum(abs(xAll1(i+1,parsGLK) - x_Y3M1(parsGLK)));
    %
    temp_HXKsim2 = interp1(simRes1_16a{i+1+8}.T_FF01, simRes1_16a{i+1+8}.V_FF01(:,2), temp_timepoints, 'pchip');
    pE16a_error_simHXK_916(i) = sum(abs( ( temp_HXKexp - temp_HXKsim2 ) ./ temp_HXKexp ));
    pE16a_error_pars_916(i) = sum(abs(xAll1(i+1+8,parsGLK) - x_Y3M1(parsGLK)));
end
...
subplot(2,2,1)
yyaxis left
semilogx(pE16a_w_refY3M1_18, pE16a_error_simHXK_18, 'o-')
hold on
yyaxis right
semilogx(pE16a_w_refY3M1_18, pE16a_error_pars_18, 'o-')
legend('error simHXK','error parameters')
title('w_{HXK} = ones -> w_{refY3M1} (semilogx)')
xlim([min(pE16a_w_refY3M1_18) max(pE16a_w_refY3M1_18)])
hold off

% loglog
subplot(2,2,2)
yyaxis left
loglog(pE16a_w_refY3M1_18, pE16a_error_simHXK_18, 'o-')
hold on
yyaxis right
loglog(pE16a_w_refY3M1_18, pE16a_error_pars_18, 'o-')
legend('error simHXK','error parameters')
...
% roc-like curve
subplot(2,2,3)
% plot(pE16a_error_simHXK_18, pE16a_error_pars_18, ...
%     'k.-', 'LineWidth', 2)
% xlabel('error_{simHXK.18}')
% ylabel('error_{pars.18}')
area([pE16a_error_pars_18(3) pE16a_error_pars_18(2)], [10 10], ...
    'FaceColor', [.9 .9 .9], 'LineStyle', 'none')
hold on
plot(pE16a_error_pars_18, pE16a_error_simHXK_18, ...
...
% suptitle
suptitle('regulatization for 16a, 1-8')
