...
% %% Turn off vacuolar storage
% % x(155:157) = [-0.1759   -1.8496         0];
% x2 = x;
% x2(155) = 10;
% 
% %
...
% 
% 
% %% putting all trehalose as cytosolic
% %
% x3 = x;
% x3(155) = -10; % vacT depletes TREic immediately
% x3(123) = -10; % % nth1 depletes TREic almost immediately
% %
% IC(25) = 80;
% IC(38) = 0;
% % 
% [T_FF01_1,Y_FF01_1,V_FF01_1] = simulate_FF_enrichment(x3,canelas_SS,data,dataset,setup,NumberCycles,plotflag,IC);
% plotMode = 2; % multiple simulations
% % 
...
% 
% 
% %% increase secretion of trehalose
% 
% %% increase degradation of trehalose_ec to glucose_ec
