...
% end
%
names_cell{1} = 'FF_pE11c_pC1_wA1.mat';
names_cell{2} = 'FF_pE11c_pC1_wA2.mat';
names_cell{3} = 'FF_pE11c_pC1_wA3.mat';
%
names_cell{4} = 'FF_pE11c_pC2_wA1.mat';
names_cell{5} = 'FF_pE11c_pC2_wA2.mat';
names_cell{6} = 'FF_pE11c_pC2_wA3.mat';
%
names_cell{7} = 'FF_pE11c_pC3_wA1.mat';
names_cell{8} = 'FF_pE11c_pC3_wA2.mat';
names_cell{9} = 'FF_pE11c_pC3_wA3.mat';
%
names_cell{10} = 'FF_pE11c_pC4_wA1.mat';
names_cell{11} = 'FF_pE11c_pC4_wA2.mat';
names_cell{12} = 'FF_pE11c_pC4_wA3.mat';
%
names_cell{13} = 'FF_pE11c_pC5_wA1.mat';
names_cell{14} = 'FF_pE11c_pC5_wA2.mat';
names_cell{15} = 'FF_pE11c_pC5_wA3.mat';
%
optimOptions2.names_cell = names_cell;
...
%
parComb_cell{4} = parCombs2;
parComb_cell{5} = parCombs2;
parComb_cell{6} = parCombs2;
% 
parComb_cell{7} = parCombs3;
parComb_cell{8} = parCombs3;
parComb_cell{9} = parCombs3;
%
parComb_cell{10} = parCombs4;
parComb_cell{11} = parCombs4;
parComb_cell{12} = parCombs4;
% 
parComb_cell{13} = parCombs5;
parComb_cell{14} = parCombs5;
parComb_cell{15} = parCombs5;
%
...
warray_cell{5}(w_idxs2) = ones;
warray_cell{6}(w_idxs3) = ones;
% 
warray_cell{7}(w_idxs1) = ones;
warray_cell{8}(w_idxs2) = ones;
warray_cell{9}(w_idxs3) = ones;
%
warray_cell{10}(w_idxs1) = ones;
warray_cell{11}(w_idxs2) = ones;
...
save('pE11c_simRes.mat','simRes1')
% % quit
% % save('pE8_simRes_updated.mat','simRes1')
%%
nParts = length(namesHits1);
simRes1 = cell(1,nParts);
load('pE11c_simRes.mat','simRes1')
...
% % %%
% for i = 1:15
%     fid = fopen('parEst11c_lastIssue2_TREec_inDepth.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
