...
save('pE12e_simRes_1.mat','simRes1_1')
...
save('pE12e_simRes_2.mat','simRes1_2')
...
save('pE12e_simRes_3.mat','simRes1_3')
...
save('pE12e_simRes_4.mat','simRes1_4')
...
save('pE12e_simRes_5.mat','simRes1_5')
...
save('pE12e_simRes_6.mat','simRes1_6')
...
save('pE12e_simRes_7.mat','simRes1_7')
...
% % % % save('pE12e_simRes_8.mat','simRes1_8')
% % % % 
% % % % % 9/10
% % % % rangeTemp = 801:900;
% % % % % parpool(4)
...
% % % % save('pE12e_simRes_9.mat','simRes1_9')
% % % % 
% % % % % 10/10
% % % % rangeTemp = 901:1000;
% % % % % parpool(4)
...
% % % % save('pE12e_simRes_10.mat','simRes1_10')


%% laod and put all data together
% load them
load('pE12e_simRes_1.mat','simRes1_1')
load('pE12e_simRes_2.mat','simRes1_2')
load('pE12e_simRes_3.mat','simRes1_3')
load('pE12e_simRes_4.mat','simRes1_4')
load('pE12e_simRes_5.mat','simRes1_5')

% load('pE12e_simRes_6.mat','simRes1_6')
% load('pE12e_simRes_7.mat','simRes1_7')
% load('pE12e_simRes_8.mat','simRes1_8')
% load('pE12e_simRes_9.mat','simRes1_9')
% load('pE12e_simRes_10.mat','simRes1_10')
...
%% screening for the few interesting points
for i = 1:lenS
    % first data point
%     if((vGLT_20(i)>0.0184)&&(vGLT_20(i)<0.0185)&&(vGLT_20(i)>0.000491)&&(vGLT_20(i)<0.000492))
    if((vGLT_20(i)>0.0184)&&(vGLT_20(i)<0.0185))
        sprintf('First case is %d. vGLT20 = %d, vGLTend = %d.', i, vGLT_20(i), vGLT_end(i))
    end
    % second data point
    if((vGLT_20(i)>0.075)&&(vGLT_20(i)<0.076))
        sprintf('Second case is %d. vGLT20 = %d, vGLTend = %d.', i, vGLT_20(i), vGLT_end(i))
    end 
    % third data point
    if((vGLT_20(i)>0.347)&&(vGLT_20(i)<0.348))
        sprintf('Third case is %d. vGLT20 = %d, vGLTend = %d.', i, vGLT_20(i), vGLT_end(i))
    end 
    % fourth data point
    if((vGLT_20(i)>0.711)&&(vGLT_20(i)<0.712))
        sprintf('Fourth case is %d. vGLT20 = %d, vGLTend = %d.', i, vGLT_20(i), vGLT_end(i))
    end 
    % fifth data point
    if((vGLT_20(i)>1.382)&&(vGLT_20(i)<1.384))
        sprintf('Fifth case is %d. vGLT20 = %d, vGLTend = %d.', i, vGLT_20(i), vGLT_end(i))
    end
end

%%
idxs = [201 175 79 435 379];
%
plotMode = 2; % multiple simulations
selResCell = simRes1(idxs);
referencePlotSimulations
plotMode = 0;
