...
%%
% which reaction do we focus in? r2_0 -> G6PDH_PGL_fwd (#15).
idx = 15;
figure,
plot(dataset.FF01.fluxes_times, dataset.FF01.fluxes{idx}, 'bo-')
title(dataset.FF01.legenda_fluxes{idx})
% what adds from pgi to pfk (difference seen in experimental data)?
% r2_0 -> G6PDH_PGL_fwd (#15).
idx2 = [25 26];
figure,
% 
subplot(221)
plot(dataset.FF01.fluxes_times, dataset.FF01.fluxes{idx2(1)}, 'bo-')
title(dataset.FF01.legenda_fluxes{idx2(1)})
% 
subplot(222)
plot(dataset.FF01.fluxes_times, dataset.FF01.fluxes{idx2(2)}, 'bo-')
title(dataset.FF01.legenda_fluxes{idx2(2)})
% 
subplot(223)
plot(dataset.FF01.fluxes_times, dataset.FF01.fluxes{idx2(1)} - dataset.FF01.fluxes{idx2(2)}, 'bo-')
title('diference')
