...
% 
% selResCell = [sim1, sim2];
% referencePlotSimulations
% plotMode = 0;
% 
% % setup.glycogenReactionsSink = 0;
...
% nPSA = 7;
% xPSA148 = [x; x; x; x; x; x; x];
%     %
%     xPSA148(1,148) = xPSA148(1,148) - 1;
%     xPSA148(2,148) = xPSA148(2,148) - 0.5;
%     xPSA148(3,148) = xPSA148(3,148) - 0.25;
%     %
%     xPSA148(5,148) = xPSA148(5,148) + 0.25;
%     xPSA148(6,148) = xPSA148(6,148) + 0.5;
%     xPSA148(7,148) = xPSA148(7,148) + 1;
% xPSA126 = [x; x; x; x; x; x; x];
%     %
%     xPSA126(1,126) = xPSA126(1,126) - 1;
%     xPSA126(2,126) = xPSA126(2,126) - 0.5;
%     xPSA126(3,126) = xPSA126(3,126) - 0.25;
%     %
%     xPSA126(5,126) = xPSA126(5,126) + 0.25;
%     xPSA126(6,126) = xPSA126(6,126) + 0.5;
%     xPSA126(7,126) = xPSA126(7,126) + 1;
...
nPSA = 7;
xLinPSA = linspace(0,6,nPSA);

xPSA = [x; x; x; x; x; x; x];
    xPSA(:,164) = xPSA(:,164) + xLinPSA';
    xPSA(:,150) = xPSA(:,150) + xLinPSA';
xPSA164 = [x; x; x; x; x; x; x];
    xPSA164(:,164) = xPSA164(:,164) + xLinPSA';
xPSA150 = [x; x; x; x; x; x; x];
    xPSA150(:,150) = xPSA150(:,150) + xLinPSA';
...
%     selResCell{1}.V_FF01 = V_FF01_1;
%     % save
%     saveName = sprintf('pE11_psa_xPSA_n%d.mat',o);
...
%     selResCell{1}.V_FF01 = V_FF01_1;
%     % save
%     saveName = sprintf('pE11_psa_x164_n%d.mat',o);
%     parsave_Y3M2_cluster_2(saveName, selResCell);
% end
% % 150
% parfor o = 1:nPSA
...
%     selResCell{1}.V_FF01 = V_FF01_1;
%     % save
%     saveName = sprintf('pE11_psa_x150_n%d.mat',o);
%     parsave_Y3M2_cluster_2(saveName, selResCell);
% end
% 
% delete(pool)
...
% simRes1 = cell(1,nPSA);
% for i = 1:nPSA
%     loadName = sprintf('pE11_psa_x164_n%d.mat',i);
%     load(loadName);
%     simRes1(i) = selResCell;
% end
% % simRes1(1) = [];
...
names_cell{2} = 'FF_pE11_n1_pC1_wA2.mat';
names_cell{3} = 'FF_pE11_n1_pC1_wA3.mat';
names_cell{4} = 'FF_pE11_n1_pC1_wA4.mat';
names_cell{5} = 'FF_pE11_n1_pC1_wA5.mat';
names_cell{6} = 'FF_pE11_n1_pC1_wA6.mat';
%
names_cell{7} = 'FF_pE11_n1_pC2_wA1.mat';
names_cell{8} = 'FF_pE11_n1_pC2_wA2.mat';
names_cell{9} = 'FF_pE11_n1_pC2_wA3.mat';
names_cell{10} = 'FF_pE11_n1_pC2_wA4.mat';
names_cell{11} = 'FF_pE11_n1_pC2_wA5.mat';
names_cell{12} = 'FF_pE11_n1_pC2_wA6.mat';
%
names_cell{13} = 'FF_pE11_n1_pC3_wA1.mat';
names_cell{14} = 'FF_pE11_n1_pC3_wA2.mat';
names_cell{15} = 'FF_pE11_n1_pC3_wA3.mat';
names_cell{16} = 'FF_pE11_n1_pC3_wA4.mat';
names_cell{17} = 'FF_pE11_n1_pC3_wA5.mat';
names_cell{18} = 'FF_pE11_n1_pC3_wA6.mat';
%
names_cell{19} = 'FF_pE11_n1_pC4_wA1.mat';
names_cell{20} = 'FF_pE11_n1_pC4_wA2.mat';
names_cell{21} = 'FF_pE11_n1_pC4_wA3.mat';
names_cell{22} = 'FF_pE11_n1_pC4_wA4.mat';
names_cell{23} = 'FF_pE11_n1_pC4_wA5.mat';
names_cell{24} = 'FF_pE11_n1_pC4_wA6.mat';
%
names_cell{25} = 'FF_pE11_n1_pC5_wA1.mat';
names_cell{26} = 'FF_pE11_n1_pC5_wA2.mat';
names_cell{27} = 'FF_pE11_n1_pC5_wA3.mat';
names_cell{28} = 'FF_pE11_n1_pC5_wA4.mat';
names_cell{29} = 'FF_pE11_n1_pC5_wA5.mat';
names_cell{30} = 'FF_pE11_n1_pC5_wA6.mat';
%
optimOptions2.names_cell = names_cell;
...
warray_cell{6}(w_idxs6) = ones;
% 
warray_cell{7}(w_idxs1) = ones;
warray_cell{8}(w_idxs2) = ones;
warray_cell{9}(w_idxs3) = ones;
warray_cell{10}(w_idxs4) = ones;
warray_cell{11}(w_idxs5) = ones;
warray_cell{12}(w_idxs6) = ones;
% 
warray_cell{13}(w_idxs1) = ones;
warray_cell{14}(w_idxs2) = ones;
warray_cell{15}(w_idxs3) = ones;
warray_cell{16}(w_idxs4) = ones;
warray_cell{17}(w_idxs5) = ones;
warray_cell{18}(w_idxs6) = ones;
% 
warray_cell{19}(w_idxs1) = ones;
warray_cell{20}(w_idxs2) = ones;
warray_cell{21}(w_idxs3) = ones;
warray_cell{22}(w_idxs4) = ones;
warray_cell{23}(w_idxs5) = ones;
warray_cell{24}(w_idxs6) = ones;
% 
warray_cell{25}(w_idxs1) = ones;
warray_cell{26}(w_idxs2) = ones;
warray_cell{27}(w_idxs3) = ones;
warray_cell{28}(w_idxs4) = ones;
warray_cell{29}(w_idxs5) = ones;
warray_cell{30}(w_idxs6) = ones;
% 
...
% end
% save('pE11b_simRes.mat','simRes1')
% % quit
% % save('pE8_simRes_updated.mat','simRes1')
%%
nParts = length(namesHits1);
simRes1 = cell(1,nParts);
load('pE11b_simRes.mat','simRes1')
...
% pC1
selResCell = tempSave(1:7);
referencePlotSimulations

% pC2
selResCell = tempSave([1,8:13]);
referencePlotSimulations

% pC3
selResCell = tempSave([1,14:19]);
referencePlotSimulations

% pC4
selResCell = tempSave([1,20:24]);
referencePlotSimulations

% pC5
selResCell = tempSave([1,25:29]);
referencePlotSimulations
...
% % %%
% for i = 1:30
%     fid = fopen('parEst11b_lastIssue_TREec_inDepth.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
