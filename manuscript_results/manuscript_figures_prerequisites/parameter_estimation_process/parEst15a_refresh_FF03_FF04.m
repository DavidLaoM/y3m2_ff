...
%% No enrichment simulations (for FF01, FF03 or FF04)
% setup.changing_Keq_glt = 0;
% 
setup.GPdataset.GP400WT = 0;
setup.GPdataset.GP1800WT = 1; % page 230 of CA_SM thesis to find the plots
setup.GPdataset.GP400M = 0;
choosedataset
% 
...
plotMode = 0;
% 
% setup.changing_Keq_glt = 3;


%% Enrichment Simulations (for FF01)
% 
setup.GPdataset.GP400WT = 1;
setup.GPdataset.GP1800WT = 0;
setup.GPdataset.GP400M = 0;
