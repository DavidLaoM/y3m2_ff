...
% end
%
names_cell{1} = 'FF_pE11f_pC1_wA1.mat';
names_cell{2} = 'FF_pE11f_pC1_wA2.mat';
names_cell{3} = 'FF_pE11f_pC1_wA3.mat';
%
names_cell{4} = 'FF_pE11f_pC2_wA1.mat';
names_cell{5} = 'FF_pE11f_pC2_wA2.mat';
names_cell{6} = 'FF_pE11f_pC2_wA3.mat';
%
names_cell{7} = 'FF_pE11f_pC3_wA1.mat';
names_cell{8} = 'FF_pE11f_pC3_wA2.mat';
names_cell{9} = 'FF_pE11f_pC3_wA3.mat';
%
names_cell{10} = 'FF_pE11f_pC4_wA1.mat';
names_cell{11} = 'FF_pE11f_pC4_wA2.mat';
names_cell{12} = 'FF_pE11f_pC4_wA3.mat';
%
names_cell{13} = 'FF_pE11f_pC5_wA1.mat';
names_cell{14} = 'FF_pE11f_pC5_wA2.mat';
names_cell{15} = 'FF_pE11f_pC5_wA3.mat';
%
names_cell{16} = 'FF_pE11f_pC6_wA3.mat';
%
optimOptions2.names_cell = names_cell;
...
pC2 = parsHXK;
pC3 = [parsGLT, parsHXK];
pC4 = [parsGLT, parsHXK, parsTreCycle];
pC5 = [parsGLT, parsHXK, parsATH1vac, parsATH1ec, parsAGT1, parsVACT];
pC6 = [parsGLT, parsHXK, parsTreCycle, parsATH1vac, parsATH1ec, parsAGT1, parsVACT];
...
warray_cell{3}(w_idxs3) = ones; warray_cell{3}(w_idxs3(end)) = 5;
%
warray_cell{4}(w_idxs1) = ones;
warray_cell{5}(w_idxs2) = ones;
warray_cell{6}(w_idxs3) = ones; warray_cell{6}(w_idxs3(end)) = 5;
%
warray_cell{7}(w_idxs1) = ones;
warray_cell{8}(w_idxs2) = ones;
warray_cell{9}(w_idxs3) = ones; warray_cell{9}(w_idxs3(end)) = 5;
%
warray_cell{10}(w_idxs1) = ones;
warray_cell{11}(w_idxs2) = ones;
warray_cell{12}(w_idxs3) = ones; warray_cell{12}(w_idxs3(end)) = 5;
%
warray_cell{13}(w_idxs1) = ones;
warray_cell{14}(w_idxs2) = ones;
warray_cell{15}(w_idxs3) = ones; warray_cell{15}(w_idxs3(end)) = 5;
%
warray_cell{16}(w_idxs3) = ones; warray_cell{16}(w_idxs3(end)) = 5;
%
...
% % %%
% for i = 1:16
%     fid = fopen('parEst11f_MA_GLCe_pEst_ath1ec_agt1.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
