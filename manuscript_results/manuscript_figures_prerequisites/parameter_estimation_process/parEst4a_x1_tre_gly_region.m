...
names_cell = cell(ntests,1);
for i = 1:ntests
    names_cell{i} = sprintf('FF_pE4_x1_wA%d',i);
end
optimOptions2.names_cell = names_cell;
...
save('pE4a_x1_simRes.mat','simRes1')
%%
load('pE4a_x1_simRes.mat','simRes1')
...
%%
for i = 1:10
%     vENO55 = interp1(selResCell{i}.T_FF01, selResCell{i}.V_FF01(:,11), 55, 'pchip');
%     fprintf('i = %f, vENO55 = %f.\n', i, vENO55);
    UGPgluc200 = interp1(selResCell{i}.T_FF01, selResCell{i}.Y_FF01(:,24), 200, 'pchip');
    fprintf('i = %f, UGPgluc200 = %f.\n', i, UGPgluc200);
end
...
x_pE4_x1_start = xAll1(1,:);
x_pE4_x1_end = xAll1(6,:);
% 
save('pset_pE4_x1res.mat','x_pE4_x1_start','x_pE4_x1_end');



% % %%
% for i = 1:16
%     fid = fopen('parEst4a_x1_tre_gly_region.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
...
%     tempName = sprintf('pE4_x1_%d.m',i);
