...
names_cell = cell(ntests,1);
for i = 1:ntests
    names_cell{i} = sprintf('FF_pE5_x1_wA%d',i);
end
optimOptions2.names_cell = names_cell;
...
save('pE5_x1_simRes.mat','simRes1')
%%
nParts = length(namesHits1);
simRes1 = cell(1,nParts);
load('pE5_x1_simRes.mat','simRes1')
...
x_pE5_x1_start = xAll1(1,:);
x_pE5_x1_end = xAll1(12,:);
% 
save('pset_pE5_x1res_temp.mat','x_pE5_x1_start','x_pE5_x1_end');


% % %%
% for i = 1:16
%     fid = fopen('parEst5_x1_glycogen_extended.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
...
%     tempName = sprintf('pE5_x1_%d.m',i);
