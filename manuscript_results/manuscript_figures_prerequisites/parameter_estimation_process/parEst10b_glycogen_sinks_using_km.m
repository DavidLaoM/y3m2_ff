...
%     selResCell{1}.V_FF01 = V_FF01_1;
%     % save
%     saveName = sprintf('pE10b_psa_x148_n%d.mat',o);
...
%     selResCell{1}.V_FF01 = V_FF01_1;
%     % save
%     saveName = sprintf('pE10b_psa_x126_n%d.mat',o);
%     parsave_Y3M2_cluster_2(saveName, selResCell);
% end
% %
% delete(pool)
...
simRes1 = cell(1,nPSA);
for i = 1:nPSA
    loadName = sprintf('pE10b_psa_x148_n%d',i);
    load(loadName);
    simRes1(i) = selResCell;
end
% simRes1(1) = [];
simRes1_x148 = simRes1;
% x148
simRes1 = cell(1,nPSA);
for i = 1:nPSA
    loadName = sprintf('pE10b_psa_x126_n%d',i);
    load(loadName);
    simRes1(i) = selResCell;
end
% simRes1(1) = [];
simRes1_x126 = simRes1;
...
% simRes1_a
selResCell = simRes1_x148;
referencePlotSimulations
% simRes1_b
selResCell = simRes1_x126;
referencePlotSimulations
...
% % end
% %
% names_cell{1} = 'FF_pE9_n1_pC1_wA1.mat';
% names_cell{2} = 'FF_pE9_n2_pC1_wA4.mat';
% names_cell{3} = 'FF_pE9_n3_pC1_wA5.mat';
% names_cell{4} = 'FF_pE9_n4_pC1_wA6.mat';
% %
% names_cell{5} = 'FF_pE9_n5_pC2_wA1.mat';
% names_cell{6} = 'FF_pE9_n6_pC2_wA2.mat';
% names_cell{7} = 'FF_pE9_n7_pC2_wA3.mat';
% names_cell{8} = 'FF_pE9_n8_pC2_wA4.mat';
% names_cell{9} = 'FF_pE9_n9_pC2_wA5.mat';
% names_cell{10} = 'FF_pE9_n10_pC2_wA6.mat';
% %
% names_cell{11} = 'FF_pE9_n11_pC3_wA1.mat';
% names_cell{12} = 'FF_pE9_n12_pC3_wA2.mat';
% names_cell{13} = 'FF_pE9_n13_pC3_wA3.mat';
% names_cell{14} = 'FF_pE9_n14_pC3_wA4.mat';
% names_cell{15} = 'FF_pE9_n15_pC3_wA5.mat';
% names_cell{16} = 'FF_pE9_n16_pC3_wA6.mat';
% %
% optimOptions2.names_cell = names_cell;
% 
...
% % 
% parComb_cell{1} = parComb_all;
% parComb_cell{2} = parComb_all;
% parComb_cell{3} = parComb_all;
% parComb_cell{4} = parComb_all;
% %
% parComb_cell{5} = parComb_GlyTre;
% parComb_cell{6} = parComb_GlyTre;
% parComb_cell{7} = parComb_GlyTre;
% parComb_cell{8} = parComb_GlyTre;
% parComb_cell{9} = parComb_GlyTre;
% parComb_cell{10} = parComb_GlyTre;
% %
% parComb_cell{11} = parComb_GlyOnly;
% parComb_cell{12} = parComb_GlyOnly;
% parComb_cell{13} = parComb_GlyOnly;
% parComb_cell{14} = parComb_GlyOnly;
% parComb_cell{15} = parComb_GlyOnly;
% parComb_cell{16} = parComb_GlyOnly;
% %
...
% warray_cell{2}(w_idxs4) = ones;
% warray_cell{3}(w_idxs5) = ones;
% warray_cell{4}(w_idxs6) = ones;
% % 
% warray_cell{5}(w_idxs1) = ones;
% warray_cell{6}(w_idxs2) = ones;
% warray_cell{7}(w_idxs3) = ones;
% warray_cell{8}(w_idxs4) = ones;
% warray_cell{9}(w_idxs5) = ones;
% warray_cell{10}(w_idxs6) = ones;
% % 
...
% end
% save('pE10_simRes.mat','simRes1')
% % save('pE8_simRes_updated.mat','simRes1')
% %%
% nParts = length(namesHits1);
% simRes1 = cell(1,nParts);
% load('pE10_simRes.mat','simRes1')
% 
% 
% %% plot data
% [legenda] = legendaFull; %legenda for the names needed
...
% % %%
% for i = 1:16
%     fid = fopen('parEst10_glycogen_sinks.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
