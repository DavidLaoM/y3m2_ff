...
names_cell = cell(ntests,1);
for i = 1:ntests
    names_cell{i} = sprintf('FF_pE6_x2_wA%d',i);
end
optimOptions2.names_cell = names_cell;
...
save('pE6_x2_simRes_updated.mat','simRes1')
% save('pE6_x2_simRes.mat','simRes1')
%%
nParts = length(namesHits1);
simRes1 = cell(1,nParts);
load('pE6_x2_simRes.mat','simRes1')
...
x_pE6_x2_start = xAll1(1,:);
x_pE6_x2_end = xAll1(12,:);
% 
save('pset_pE6_x2res.mat','x_pE6_x2_start','x_pE6_x2_end');


% % %%
% for i = 1:16
%     fid = fopen('parEst6_x2_start_tre.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
...
%     tempName = sprintf('pE6_x2_%d.m',i);
