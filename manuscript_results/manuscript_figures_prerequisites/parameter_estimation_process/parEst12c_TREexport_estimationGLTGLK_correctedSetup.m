...
% end
%
names_cell{1} = 'FF_pE12c_pC1_wA1_start%d_nS%d.mat';
names_cell{2} = 'FF_pE12c_pC1_wA2_start%d_nS%d.mat';
%
names_cell{3} = 'FF_pE12c_pC2_wA1_start%d_nS%d.mat';
names_cell{4} = 'FF_pE12c_pC2_wA2_start%d_nS%d.mat';
%
names_cell{5} = 'FF_pE12c_pC3_wA1_start%d_nS%d.mat';
names_cell{6} = 'FF_pE12c_pC3_wA2_start%d_nS%d.mat';
%
names_cell{7} = 'FF_pE12c_pC4_wA1_start%d_nS%d.mat';
names_cell{8} = 'FF_pE12c_pC4_wA2_start%d_nS%d.mat';
%
optimOptions2.names_cell = names_cell;
...
%         sprintf('o = %d, o2 = %d.', o, o2)
    ...
    %     setup.w = warray;
        ...
        % 'FF_pE12b_pC3_wA2_start%d_nS%d.mat'
        saveName = sprintf(tempName,o2,nSeries);
...
% % %%
% for i = 1:16
%     fid = fopen('parEst12c_TREexport_estimationGLTGLK_correctedSetup.m','rt');
%     X = fread(fid);
%     fclose(fid);
%     X = char(X.');
