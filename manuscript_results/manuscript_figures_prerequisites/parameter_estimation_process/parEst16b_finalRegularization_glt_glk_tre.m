...
% end
% 
% % % % names_cell{1} = 'FF_pE16a_glk_wA1.mat';
% % % % names_cell{2} = 'FF_pE16a_glk_wA2.mat';
% % % % names_cell{3} = 'FF_pE16a_glk_wA3.mat';
% % % % names_cell{4} = 'FF_pE16a_glk_wA4.mat';
% % % % names_cell{5} = 'FF_pE16a_glk_wA5.mat';
% % % % names_cell{6} = 'FF_pE16a_glk_wA6.mat';
% % % % names_cell{7} = 'FF_pE16a_glk_wA7.mat';
% % % % names_cell{8} = 'FF_pE16a_glk_wA8.mat';
% % % % %
% % % % names_cell{9} = 'FF_pE16a_glk_wA9.mat';
% % % % names_cell{10} = 'FF_pE16a_glk_wA10.mat';
% % % % names_cell{11} = 'FF_pE16a_glk_wA11.mat';
% % % % names_cell{12} = 'FF_pE16a_glk_wA12.mat';
% % % % names_cell{13} = 'FF_pE16a_glk_wA13.mat';
% % % % names_cell{14} = 'FF_pE16a_glk_wA14.mat';
% % % % names_cell{15} = 'FF_pE16a_glk_wA15.mat';
% % % % names_cell{16} = 'FF_pE16a_glk_wA16.mat';
% 
names_cell{1} = 'FF_pE16b_glt_glk_tre_wA1.mat';
names_cell{2} = 'FF_pE16b_glt_glk_tre_wA2.mat';
names_cell{3} = 'FF_pE16b_glt_glk_tre_wA3.mat';
names_cell{4} = 'FF_pE16b_glt_glk_tre_wA4.mat';
names_cell{5} = 'FF_pE16b_glt_glk_tre_wA5.mat';
names_cell{6} = 'FF_pE16b_glt_glk_tre_wA6.mat';
names_cell{7} = 'FF_pE16b_glt_glk_tre_wA7.mat';
names_cell{8} = 'FF_pE16b_glt_glk_tre_wA8.mat';
% 
names_cell{9} = 'FF_pE16b_glt_glk_tre_wA9.mat';
names_cell{10} = 'FF_pE16b_glt_glk_tre_wA10.mat';
names_cell{11} = 'FF_pE16b_glt_glk_tre_wA11.mat';
names_cell{12} = 'FF_pE16b_glt_glk_tre_wA12.mat';
names_cell{13} = 'FF_pE16b_glt_glk_tre_wA13.mat';
names_cell{14} = 'FF_pE16b_glt_glk_tre_wA14.mat';
names_cell{15} = 'FF_pE16b_glt_glk_tre_wA15.mat';
names_cell{16} = 'FF_pE16b_glt_glk_tre_wA16.mat';
%
optimOptions2.names_cell = names_cell;
...
% 
warray_cell{9}(w_simHXK) = ones * 1E-3;
warray_cell{10}(w_simHXK) = ones * 1E-2;
warray_cell{11}(w_simHXK) = ones * 1E-1;
warray_cell{12}(w_simHXK) = ones * 1E0;
warray_cell{13}(w_simHXK) = ones * 3E0;
warray_cell{14}(w_simHXK) = ones * 1E1;
warray_cell{15}(w_simHXK) = ones * 1E2;
warray_cell{16}(w_simHXK) = ones * 1E3;
% 
...
% 
warray_cell{9}(w_refY3M1) = ones;
warray_cell{10}(w_refY3M1) = ones;
warray_cell{11}(w_refY3M1) = ones;
warray_cell{12}(w_refY3M1) = ones;
warray_cell{13}(w_refY3M1) = ones;
warray_cell{14}(w_refY3M1) = ones;
warray_cell{15}(w_refY3M1) = ones;
warray_cell{16}(w_refY3M1) = ones;
% 
...
% %%
simRes1_16b = simRes1;
save('tempRes_16b.mat','simRes1_16b')
%%
load('tempRes_16b.mat','simRes1_16b')


%% Visualizing results

% visualize (1:8), v_simHXK = ones, w_refY3M1 = increasing
selResCell = simRes1_16b([1,2:9]);
% selResCell = simRes1_16b([1,2:8]);
plotMode = 2;
referencePlotSimulations_enrichment
plotMode = 0;

% visualize (9:16), v_simHXK = increasing, w_refY3M1 = ones
selResCell = simRes1_16b([1,10:17]);
% selResCell = simRes1_16b([1,9:14]);
plotMode = 2;
referencePlotSimulations_enrichment
plotMode = 0;
...
nPoints = 8;
%
pE16b_w_simHXK_18 = ones(1,nPoints);
pE16b_w_refY3M1_18 = [1E-3 1E-2 1E-1 1E0 3E0 1E1 1E2 1E3];
%
pE16b_w_simHXK_916 = [1E-3 1E-2 1E-1 1E0 3E0 1E1 1E2 1E3];
pE16b_w_refY3M1_916 = ones(1,nPoints);

% 
pE16b_error_simHXK_18 = zeros(1,nPoints);
pE16b_error_simHXK_916 = zeros(1,nPoints);
pE16b_error_pars_18 = zeros(1,nPoints);
pE16b_error_pars_916 = zeros(1,nPoints);
% 
temp_time = simRes1_16b{1}.T_FF01;
temp_hxk = simRes1_16b{1}.V_FF01(:,2);
temp_timepoints = [6:5:26, 76:50:376];
temp_HXKexp = interp1(temp_time, temp_hxk, temp_timepoints, 'pchip');
for i = 1:nPoints
    %
    temp_HXKsim = interp1(simRes1_16b{i+1}.T_FF01, simRes1_16b{i+1}.V_FF01(:,2), temp_timepoints, 'pchip');
    pE16b_error_simHXK_18(i) = sum(abs( ( temp_HXKexp - temp_HXKsim ) ./ temp_HXKexp ));
    pE16b_error_pars_18(i) = sum(abs(xAll1(i+1,parsGLK) - x_Y3M1(parsGLK)));
    %
    temp_HXKsim2 = interp1(simRes1_16b{i+1+8}.T_FF01, simRes1_16b{i+1+8}.V_FF01(:,2), temp_timepoints, 'pchip');
    pE16b_error_simHXK_916(i) = sum(abs( ( temp_HXKexp - temp_HXKsim2 ) ./ temp_HXKexp ));
    pE16b_error_pars_916(i) = sum(abs(xAll1(i+1+8,parsGLK) - x_Y3M1(parsGLK)));
end
...
subplot(2,2,1)
yyaxis left
semilogx(pE16b_w_refY3M1_18, pE16b_error_simHXK_18, 'o-')
hold on
yyaxis right
semilogx(pE16b_w_refY3M1_18, pE16b_error_pars_18, 'o-')
legend('error simHXK','error parameters')
title('w_{HXK} = ones -> w_{refY3M1} (semilogx)')
xlim([min(pE16b_w_refY3M1_18) max(pE16b_w_refY3M1_18)])
hold off

% loglog
subplot(2,2,2)
yyaxis left
loglog(pE16b_w_refY3M1_18, pE16b_error_simHXK_18, 'o-')
hold on
yyaxis right
loglog(pE16b_w_refY3M1_18, pE16b_error_pars_18, 'o-')
legend('error simHXK','error parameters')
title('w_{HXK} = ones -> w_{refY3M1} (loglog)')
xlim([min(pE16b_w_refY3M1_18) max(pE16b_w_refY3M1_18)])
hold off

% roc-like curve
subplot(2,2,3)
area([pE16b_error_pars_18(3) pE16b_error_pars_18(2)], [10 10], ...
    'FaceColor', [.9 .9 .9], 'LineStyle', 'none')
hold on
plot(pE16b_error_pars_18, pE16b_error_simHXK_18, ...
...
% suptitle
suptitle('regulatization for 16b, 1-8')
...
subplot(2,2,1)
yyaxis left
semilogx(pE16b_w_simHXK_916, pE16b_error_simHXK_916, 'o-')
hold on
yyaxis right
semilogx(pE16b_w_simHXK_916, pE16b_error_pars_916, 'o-')
legend('error simHXK','error parameters')
title('w_{refY3M1} = ones -> w_{HXK} (semilogx)')
xlim([min(pE16b_w_simHXK_916) max(pE16b_w_simHXK_916)])
hold off

% loglog
subplot(2,2,2)
yyaxis left
loglog(pE16b_w_simHXK_916, pE16b_error_simHXK_916, 'o-')
hold on
yyaxis right
loglog(pE16b_w_simHXK_916, pE16b_error_pars_916, 'o-')
legend('error simHXK','error parameters')
...
% roc-like curve
subplot(2,2,3)
area([pE16b_error_pars_916(6) pE16b_error_pars_916(7)], [10 10], ...
    'FaceColor', [.9 .9 .9], 'LineStyle', 'none')
hold on
plot(pE16b_error_pars_916, pE16b_error_simHXK_916, ...
    'ko-', 'LineWidth', 1.5, 'MarkerFaceColor', 'k')
set(gca,'xdir','reverse')
xlabel('error_{pars.18}')
ylabel('error_{simHXK.18}')
...
% suptitle
suptitle('regulatization for 16b, 9-16')


%% Visualizing results: simulating/studying the middle case that seems to be interesting

% visualize (1:8), v_simHXK = ones, w_refY3M1 = increasing
selResCell = simRes1_16b([1,3,4]);
% selResCell = simRes1_16b([1,2:8]);
plotMode = 2;
referencePlotSimulations_enrichment
plotMode = 0;
...
%%
% visualize (9:16), v_simHXK = increasing, w_refY3M1 = ones
% selResCell = simRes1_16b([1,15:16]);
selResCell = simRes1_16b([1,13:14]);
% selResCell = simRes1_16b([1,9:14]);
plotMode = 2;
referencePlotSimulations_enrichment
plotMode = 0;
...
subplot(2,3,[4 5])
for i = xlen
    wid = maxWidth * (abs(xSel(3,parsTre(i)) - xSel(4,parsTre(i)))/maxRange);
    line([xlen(i) xlen(i)],[min([xSel(3,parsTre(i)) xSel(4,parsTre(i))]) max([xSel(3,parsTre(i)) xSel(4,parsTre(i))])],...
        'Color','black','LineWidth',wid)
    if((i < 5)||(i == 6)||(i == 9)||(i == 12))
